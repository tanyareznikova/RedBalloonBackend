...
console.log('This script populates some test books, authors, genres and bookinstances to your database. ' +
    'Specified database as argument - e.g.: populatedb mongodb://localhost:27017/RedBalloonDB');
...
var ProductCharacteristics = require('./models/productCharacteristics')
var BindingCharacteristics = require('./models/bindingCharacteristics')
var DisplayCharacteristics = require('./models/displayCharacteristics')
var CameraCharacteristics = require('./models/cameraCharacteristics')
var CPUcharacteristics = require('./models/cpuCharacteristics')
var MemoryCharacteristics = require('./models/memoryCharacteristics')
var MultimediaCharacteristics = require('./models/multimediaCharacteristics')
var SystemCharacteristics = require('./models/systemCharacteristics')
var SimCardCharacteristics = require('./models/simCardCharacteristics')
var SupplyCharacteristics = require('./models/supplyCharacteristics')
var BodyCharacteristics = require('./models/bodyCharacteristics')
var OtherCharacteristics = require('./models/otherCharacteristics')
...
//
var imgPathToProduct = './public/images/productImg/huawei/';
var imgPathToBuy = './public/images/logo/svyaznoy.png';
